...
function App() {
  ...
  return (
    <>
      ...
      <Home Skill1="Front-end Devloper" Skill2="Web-Designer" YourInfo="A passionate Front-end React Developer and fully Responsive Designer based in Lahore, Pakistan. 📍" LinkedIn="" GitHub="https://github.com/Tayyab-Tech" YourImg="/my-img.png" YourImgAlt="my-img" />
